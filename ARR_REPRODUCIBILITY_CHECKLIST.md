...
**Yes.** The annotation workbook templates (Excel files with Layer 1 + Layer 2 sheets, bilingual EN/AR instructions, automated DQI/MPQS gating) are released in the repository alongside Appendix D.
